const apiKey = 'e316d11c0eec27aeb31484290547347b'; // Your API key
...
async function loadNews() {
    ...
    let url = `https://gnews.io/api/v4/search?apikey=${apiKey}&q=${encodeURIComponent(query)}&lang=${language}&in=${searchIn}`;
    ...
    articles.forEach(article => {
        if (article.image) {
            ...
            card.innerHTML = `
                ...
                <a href="${article.url}" target="_blank" class="ac">More...</a>
            `;
